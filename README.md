...
If you have managed to get working any of the following please let me know:
 ...
 - Papirus icon theme
   - Blueman-applet tray icon no longer differentiates between bluetooth enabled and bluetooth connected [PapirusDevelopmentTeam/papirus-icon-theme#4077](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme/issues/4077)
 - Starship
 ...
 - Watch (procps-ng)
   - `watch` does not handle terminal resize correctly, output stays wrapped/garbled at the old size until the command is restarted [procps-ng/procps#417](https://gitlab.com/procps-ng/procps/-/issues/417)
 - Wezterm
